        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a class="active-menu" href="add_galary.php"><i class="fa fa-qrcode"></i> Add Galary</a>
                    </li>
                            ...
                            <div class="table-responsive">
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    if (isset($_FILES['image']['name'])) {
                                        $galary_image = $_FILES['image']['name'];
                                        $tmp_image = $_FILES['image']['tmp_name'];
                                        move_uploaded_file($tmp_image, "images/$galary_image");
                                    }else{
                                        $galary_image = "";
                                    }
                                    $sql = "INSERT INTO `galary`(`image_name`, `galary_image`) VALUES ('$name','$galary_image')";
                                    ...
                                    if ($result) {
                                        ...
                                        echo "<script>window.open('add_galary.php','_self')</script>";
                                    }
                                }
