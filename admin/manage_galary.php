        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="manage_galary.php"><i class="fa fa-qrcode"></i> Manage Galary</a>
                    </li>
                                    ...
                                    $i = 0;
										...
										?>	
												...
												<tr class='gradeC'>
													...
													<td><?php echo $name; ?></td>
													<td>
                                                        <img src="images/<?php echo $galary_image;?>" style="height: 100px; width: 150px">                                       
                                                    </td>
													<td>
                                                        
                                                        <a href="DeletePage/delete_galary.php?id=<?php echo $id ;?>" class="btn btn-danger">Delete Galary</a>                                       
                                                    </td>
