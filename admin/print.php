...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>GREEN VALID,</p>
				<p>Savar Road,<br>Dhaka,<br>Bangladesh.</p>
				<p>(+88) 01733577800</p>
			</address>
			<span><img alt="" src="assets/img/VALID.jpg"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@GREENVALID.com || Web :- www.GREENVALID.com || Phone :- +8801733577800 </p>
			</div>
		</aside>
	</body>
</html>
