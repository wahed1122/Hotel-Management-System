        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="manage_visitor.php"><i class="fa fa-qrcode"></i> Manage Visitor</a>
                    </li>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									$i = 0;
									include('db.php');
									//get all information from visitor table
									...
									?>
										...
										<tr class='gradeC'>
													...
													<td><?php echo $visitor_country; ?></td>
													<td>
                                                        <img src="visitor/<?php echo $visitor_image; ?>" style="height: 150px; width: 150px">                                       
                                                    </td>
													<td>
                                                         
                                                        <a href="DeletePage/delete_visitor.php?id=<?php echo $id ; ?>" class="btn btn-danger">Delete Visitor</a>                                       
                                                    </td>
